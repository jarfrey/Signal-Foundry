...
CREATE TABLE IF NOT EXISTS posting (
  ...
  title           TEXT,
  location_raw    TEXT,
  department_raw  TEXT,    -- not pulled
  description     TEXT,    -- not pulled
  url             TEXT,    
  posted_at       TEXT,    -- not pulled
  updated_at      TEXT,    
  raw_json        TEXT,    -- not saved and idk how to
...
SELECT company_id, slug, display_name, industry, employee_est, created_at FROM company; --bs
